package com.steeplesoft.jexer.examples.jexertilingwindowmanager;

import com.steeplesoft.jexer.TApplication;
import com.steeplesoft.jexer.TKeypress;
import com.steeplesoft.jexer.TTerminalWindow;
...
public class JexerTilingWindowManager extends TApplication {
    ...
    private void splitVertical() {
        ...
        tile.onResize(new TResizeEvent(getBackend(),
        ...
        TTerminalWindow tile = new TTerminalWindow(this, x, y,
            ...
            public void onClose() {
                ...
                if (otherTile != null) {
                    ...
                    otherTile.onResize(new TResizeEvent(getBackend(), TResizeEvent.Type.WIDGET,
            ...
            public void onIdle() {
                super.onIdle();
                removeShortcutKeypress(TKeypress.kbAltT);
                removeShortcutKeypress(TKeypress.kbF6);
            }
